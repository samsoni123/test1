/*! For license information please see main.961daab2.js.LICENSE.txt */
(() => {
  "use strict";
  var e = {
      730: (e, n, t) => {
        ...
        function Kn(e, n, t, r) {
          if (Hn) {
            var l = Yn(e, n, t, r);
            if (null === l) Br(e, n, r, Xn, t), Dn(e, r);
            else if (
              (function (e, n, t, r, l) {
                switch (n) {
                  case "focusin":
              ...
              for (; null !== l; ) {
                ...
                if (
                  (null !== a && Sn(a),
                  null === (a = Yn(e, n, t, r)) && Br(e, n, r, Xn, t),
                  a === l)
                )
                  break;
                l = a;
        ...
        function xs() {
          if (null !== Xi) {
            var e = wn(Yi),
              ...
              t = kn;
            try {
              if (((Ni.transition = null), (kn = 16 > e ? 16 : e), null === Xi))
                var r = !1;
              else {
                if (((e = Xi), (Xi = null), (Yi = 0), 0 !== (6 & zi)))
                  throw Error(a(331));
                var l = zi;
  ...
  (t.m = e),
    ...
    (t.u = (e) => "static/js/" + e + ".c525d7c0.chunk.js"),
    (t.miniCssF = (e) => {}),
    ...
    (() => {
      ...
      var n = (n, r) => {
        ...
        r = (self.webpackChunkfirstapp = self.webpackChunkfirstapp || []);
    ...
    (() => {
      ...
      const l = function (e) {
        let { strikeClass: n } = e;
        return (0, r.jsx)("div", { className: "strike ".concat(n) });
      };
      const a = function (e) {
        let { className: n, value: t, onClick: l, playerTurn: a } = e,
          o = null;
        return (
          null == t && null != a && (o = "".concat(a.toLowerCase(), "-hover")),
          (0, r.jsx)("div", {
            onClick: l,
            className: "tile ".concat(n, " ").concat(o),
            children: t,
          })
        );
      };
      const o = function (e) {
          let { tiles: n, onTileClick: t, playerTurn: o, strikeClass: u } = e;
          return (0, r.jsxs)("div", {
            className: "board",
            children: [
              (0, r.jsx)(a, {
              ...
              (0, r.jsx)(l, { strikeClass: u }),
            ],
          });
        },
        u = { playerXWins: 0, playerOWins: 1, draw: 2, inProgress: 3 };
      const i = function (e) {
        let { gameState: n } = e;
        switch (n) {
          case u.inProgress:
      ...
      const s = function (e) {
        ...
        c = t.p + "static/media/game_over.3894918f7585f9300350.wav",
        f = t.p + "static/media/click.450b31dca5ff2247781d.wav",
        d = new Audio(c);
      d.volume = 0.2;
      const p = new Audio(f);
      p.volume = 0.5;
      ...
      const v = function () {
        const [n, t] = (0, e.useState)(Array(9).fill(null)),
          [l, a] = (0, e.useState)(m),
          [c, f] = (0, e.useState)(),
          [v, g] = (0, e.useState)(u.inProgress);
        return (
          (0, e.useEffect)(() => {
            !(function (e, n, t) {
              for (const { combo: r, strikeClass: l } of h) {
                const a = e[r[0]],
                  o = e[r[1]],
                  i = e[r[2]];
                if (null !== a && a === o && a === i)
                  return n(l), void t(a === m ? u.playerXWins : u.playerOWins);
              }
              e.every((e) => null !== e) && t(u.draw);
            })(n, f, g);
          }, [n]),
          (0, e.useEffect)(() => {
            n.some((e) => null !== e) && p.play();
          }, [n]),
          (0, e.useEffect)(() => {
            v !== u.inProgress && d.play();
          }, [v]),
          (0, r.jsxs)("div", {
            children: [
              (0, r.jsx)("h1", { children: "Tic Tac Toe" }),
              (0, r.jsx)(o, {
                playerTurn: l,
                tiles: n,
                onTileClick: (e) => {
                  if (v !== u.inProgress) return;
                  if (null !== n[e]) return;
                  const r = [...n];
                  (r[e] = l), t(r), a(l === m ? "O" : m);
                },
              ...
              (0, r.jsx)(i, { gameState: v }),
              (0, r.jsx)(s, {
                gameState: v,
                onReset: () => {
                  g(u.inProgress), t(Array(9).fill(null)), a(m), f(null);
                },
              }),
            ],
          })
      ...
      n
        ...
        .render((0, r.jsx)(e.StrictMode, { children: (0, r.jsx)(g, {}) })),
        y();
    })();
})();
//# sourceMappingURL=main.961daab2.js.map
